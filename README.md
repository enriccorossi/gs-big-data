...
Procure a DAG pipeline_satelite_densidade_urbana.

Ative a DAG (Unpause) e clique no botão de Trigger (Play).

Acompanhe a execução pela aba Graph.

👨‍💻 Autores
Projeto desenvolvido para a disciplina de Engenharia de Dados - FIAP (Cybersecurity e Infraestrutura de TI).
